...
const videoUrl = 'https://fb.watch/uWSF7ULtHZ/';
export const Hero = () => {
  return (
    <>
          ...
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-2 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                <div>
                  <img
                    src="/img/facebook.svg" alt="Descripción de la imagen" // Asegúrate de que esta imagen esté en la carpeta public
                    width="24"  // Mismo ancho que el SVG
                    height="24" // Mismo alto que el SVG
                    className="w-5 h-5" // Misma clase para los estilos
                  />
                </div>
                <span>Síguenos</span>
              </a>
              <a
                ...
                <div>
                  <img
                    src="/img/situ.png" alt="Descripción de la imagen" // Asegúrate de que esta imagen esté en la carpeta public
                    width="24"  // Mismo ancho que el SVG
                    height="24" // Mismo alto que el SVG
                    className="w-5 h-5" // Misma clase para los estilos
                  />
